...
export default function Home() {
  ...
  <div className="mt-40">
      ...
      <section className="py-20 bg-blue-600">
        ...
        <h2 className="text-3xl font-bold text-center text-white mb-6">Ready to Take Control of  Your Finances ?</h2>
          ...
          <Button size="lg"
           className="bg-white text-blue-600 hover:bg-black animate-bounce">Start Free Trial</Button>
           </Link>
      </section>
    </div>
    );
